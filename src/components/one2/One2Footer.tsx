...
export function One2Footer() {
  ...
  const rawSocials = [
    ...
    { id: 'telegram', icon: <TelegramIcon />, key: 'social_telegram_url', hoverClass: 'hover:bg-[#229ED9] hover:text-white hover:border-[#229ED9] hover:shadow-[0_5px_20px_rgba(34,158,217,0.4)]' },
  ];
